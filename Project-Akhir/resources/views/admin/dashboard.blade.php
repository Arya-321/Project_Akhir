...
// Bar Chart Example
// var lbl = [@foreach($ar_totals as $total) '{{$total->namaPengunjung}}',
// @endforeach];
...
var lbl2 = [@foreach ($ar_totals as $totalPengunjung) '{{$totalPengunjung->namaPengunjung}}',
@endforeach];
var hrt = [@foreach($ar_totals as $totalPengunjung) {{$totalPengunjung->alamat}},
@endforeach];
// var ctx = document.getElementById("myBarChart");
// var myLineChart = new Chart(ctx, 
document.addEventListener("DOMContentLoaded", () => {
