...
<h1 align="center"> Form Tambah Tempat Wisata</h1>
<form method="POST" action="{{url('admin/tmpt_wisata/store')}}" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text1" name="namatmpt_wisata" type="text" class="form-control" placeholder="masukan nama tempat wisata">
        </div>
    </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="textarea" name="deskripsi" type="text" class="form-control" placeholder="masukan deskripsi wisata">
        </div>
    </div>
    <div class="form-group row">
        <label for="text3" class="col-4 col-form-label">gambar</label>
        <div class="col-8">
            <input id="text3" name="gambar" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
