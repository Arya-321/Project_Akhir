...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="{{url('frontend/home')}}" class="nav-link">Beranda</a></li>
                  <li><a href="{{url('frontend/about')}}" class="nav-link">Tentang</a></li>
      ...
      <div class="site-section-cover overlay" style="background-image: url('{{asset('frontend/images/hero_1.jpg')}}')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5" data-aos="fade-right">
              <h1 class="mb-3 text-white">Mari Nikmati Keindahan  Alam</h1>
              <p>Di antara hiruk-pikuk dunia, mari kita berdiam sejenak dan merasakan keindahan alam yang mempesona..</p>
              <p class="d-flex align-items-center">
                <a href="https://vimeo.com/191947042" data-fancybox class="play-btn-39282 mr-3"><span class="icon-play"></span></a> 
                <span class="small">Tonton videonya</span>
              </p>
            </div>
          </div>
        </div>
